...
export class StudentService {
  getStudentsData() {
      ...
      },
      {
        ...
        image: 'avatar10.jpg',
        dateOfBirth: new Date(1999, 7,8),
        address: 'Le Thanh Nghi - Vinh',
        gender: false,
        phoneNumber: '0912458763',
        email: 'cuongnv@gmail.com'
      },
      {
        id: 'SV12',
        name: 'Phan Thi Nga',
        image: 'avatar11.jpg',
        dateOfBirth: new Date('2003, 6,4'),
        address: 'Mai Dich - Ha Noi',
        gender: true,
        phoneNumber: '0945673218',
        email: 'ngapt@gmail.com'
      },
      {
        id: 'SV13',
        name: 'Le Van Thanh',
        image: 'avatar12.jpg',
        dateOfBirth: new Date(1997,5,8),
        address: 'Phan Boi Chau - Da Nang',
        gender: false,
        phoneNumber: '0981234567',
        email: 'thanhlv@gmail.com'
      },
      {
        id: 'SV14',
        name: 'Tran Van Khanh',
        image: 'avatar13.jpg',
        dateOfBirth: new Date(2000,4,9),
        address: 'Ly Thai To - Ho Chi Minh City',
        gender: false,
        phoneNumber: '0976534210',
      ...
      },
      {
        ...
        name: 'Le Van Long',
        image: 'avatar15.jpg',
        dateOfBirth: new Date(1998,6,9),
        address: 'Ly Thuong Kiet - Ha Noi',
        gender: false,
        phoneNumber: '0910987654',
        email: 'longlv@gmail.com'
      },
      {
        id: 'SV17',
        name: 'Tran Thi Anh',
      ...
      },
      {
        ...
        name: 'Nguyen Van Huy',
        image: 'avatar17.jpg',
        dateOfBirth: new Date(1998,12,8),
        address: 'Nguyen Hue - Ho Chi Minh City',
        gender: false,
      ...
      },
      {
        ...
        name: 'Le Van C',
        image: 'avatar3.jpg',
        dateOfBirth: new Date(1999,7,20),
        address: '789 Road, Village, Country',
        gender: false,
        phoneNumber: '0943212345',
        email: 'levanc@gmail.com'
